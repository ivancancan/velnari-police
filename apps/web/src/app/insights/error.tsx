  ...
  return (
    <div className="min-h-screen bg-midnight-command flex items-center justify-center p-8">
      <div className="text-center max-w-sm">
        ...
        <h2 className="text-lg font-semibold text-signal-white mb-2">Error al cargar Insights</h2>
        <p className="text-slate-400 text-sm mb-6">
          {error.message || 'No se pudieron cargar las métricas. Intenta de nuevo.'}
        </p>
        <button
          onClick={reset}
